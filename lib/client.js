...
const EVENT_FIELDS = [
	...
	{
		key: "questionAsked",
		label: "模型提问通知 (ask_user_question)"
	}
];
const cardStyle = {
	display: "flex",
...
const NotifySettingsSection = function NotifySettingsSection$1(props) {
	...
	return react.default.createElement("div", { style: cardStyle }, react.default.createElement("div", { style: sectionTitleStyle }, "通知事件"), ...EVENT_FIELDS.map(({ key, label }) => {
